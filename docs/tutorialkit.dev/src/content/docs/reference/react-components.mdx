...
<PackageManagerTabs>
  <Fragment slot="npm">
  ```shell
  npm install @tutorialkit/react @tutorialkit/theme unocss @iconify-json/ph fast-glob
  ```
  </Fragment>
  <Fragment slot="pnpm">
  ```shell
  pnpm install @tutorialkit/react @tutorialkit/theme unocss @iconify-json/ph fast-glob
  ```
  </Fragment>
  <Fragment slot="yarn">
  ```shell
  yarn add @tutorialkit/react @tutorialkit/theme unocss @iconify-json/ph fast-glob
  ```
  </Fragment>
</PackageManagerTabs>
