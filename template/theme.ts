  ...
  colors: {
    ...
    tk: {
      ...
      elements: {
        ...
        breadcrumb: {
          navButton: {
            iconColor: 'var(--tk-elements-breadcrumb-navButton-iconColor)',
            iconColorHover: 'var(--tk-elements-breadcrumb-navButton-iconColorHover)',
            iconColorDisabled: 'var(--tk-elements-breadcrumb-navButton-iconColorDisabled)',
          },
          toggleButton: {
            backgroundColor: 'var(--tk-elements-breadcrumb-toggleButton-backgroundColor)',
            backgroundColorHover: 'var(--tk-elements-breadcrumb-toggleButton-backgroundColorHover)',
            backgroundColorSelected: 'var(--tk-elements-breadcrumb-toggleButton-backgroundColorSelected)',
            borderColor: 'var(--tk-elements-breadcrumb-toggleButton-borderColor)',
            borderColorHover: 'var(--tk-elements-breadcrumb-toggleButton-borderColorHover)',
            borderColorSelected: 'var(--tk-elements-breadcrumb-toggleButton-borderColorSelected)',
            textColor: 'var(--tk-elements-breadcrumb-toggleButton-textColor)',
            textColorHover: 'var(--tk-elements-breadcrumb-toggleButton-textColorHover)',
            textColorSelected: 'var(--tk-elements-breadcrumb-toggleButton-textColorSelected)',
            textDividerColor: 'var(--tk-elements-breadcrumb-toggleButton-textDividerColor)',
            textDividerColorHover: 'var(--tk-elements-breadcrumb-toggleButton-textDividerColorHover)',
            textDividerColorSelected: 'var(--tk-elements-breadcrumb-toggleButton-textDividerColorSelected)',
            iconColor: 'var(--tk-elements-breadcrumb-toggleButton-iconColor)',
            iconColorHover: 'var(--tk-elements-breadcrumb-toggleButton-iconColorHover)',
            iconColorSelected: 'var(--tk-elements-breadcrumb-toggleButton-iconColorSelected)',
          },
          dropdown: {
            backgroundColor: 'var(--tk-elements-breadcrumb-dropdown-backgroundColor)',
            borderColor: 'var(--tk-elements-breadcrumb-dropdown-borderColor)',
            textColor: 'var(--tk-elements-breadcrumb-dropdown-textColor)',
            textColorHover: 'var(--tk-elements-breadcrumb-dropdown-textColorHover)',
            accordionTextColor: 'var(--tk-elements-breadcrumb-dropdown-accordionTextColor)',
            accordionTextColorHover: 'var(--tk-elements-breadcrumb-dropdown-accordionTextColorHover)',
            accordionIconColor: 'var(--tk-elements-breadcrumb-dropdown-accordionIconColor)',
            accordionIconColorHover: 'var(--tk-elements-breadcrumb-dropdown-accordionIconColorHover)',
            lessonBackgroundColor: 'var(--tk-elements-breadcrumb-dropdown-lessonBackgroundColor)',
            lessonBackgroundColorSelected: 'var(--tk-elements-breadcrumb-dropdown-lessonBackgroundColorSelected)',
            lessonTextColor: 'var(--tk-elements-breadcrumb-dropdown-lessonTextColor)',
            lessonTextColorHover: 'var(--tk-elements-breadcrumb-dropdown-lessonTextColorHover)',
          },
        },
        status: {
          positive: {
